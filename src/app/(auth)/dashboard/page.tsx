    ...
    <div className="p-8">
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-8 text-center">
          ...
          <h3 className="mb-2 text-lg font-semibold text-gray-900">Patient Engagement</h3>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="rounded-xl border border-gray-200 bg-white p-8 text-center">
            ...
            <h3 className="mb-2 text-lg font-semibold text-gray-900">Recent Reflections</h3>
            <p className="mb-4 text-sm text-gray-600">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-8 text-center">
            ...
            <h3 className="mb-2 text-lg font-semibold text-gray-900">Recent Survey Responses</h3>
            <p className="mb-4 text-sm text-gray-600">
