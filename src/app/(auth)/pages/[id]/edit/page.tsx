  ...
  const fetchPage = useCallback(async () => {
    ...
    try {
      ...
      const transformedBlocks: ContentBlock[] = dbBlocks.map((block: any) => {
        // Strip displayUrl from settings — it's a stale presigned URL that would
        // override the fresh mediaUrl generated by the API
        const { displayUrl: _discarded, ...settingsWithoutDisplayUrl } = (block.settings || {}) as any;
        const baseBlock = {
          id: block.id,
