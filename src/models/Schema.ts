...
export const uploadedRecordingStatusEnum = pgEnum('uploaded_recording_status', [
  ...
  'merging', // Audio chunks being merged via Cloud Run
...
export const sessionsSchema = pgTable('sessions', {
  ...
  // Archive: hide from default list without deleting
  archivedAt: timestamp('archived_at'),
...
export const therapistPatientArchivesSchema = pgTable(
  ...
  table => [
    unique('therapist_patient_archive_unique').on(table.therapistId, table.patientId),
    index('therapist_patient_archives_therapist_idx').on(table.therapistId),
    index('therapist_patient_archives_patient_idx').on(table.patientId),
  ],
);

export const therapistPatientArchives = therapistPatientArchivesSchema;
