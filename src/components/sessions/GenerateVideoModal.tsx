  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 mx-4 flex max-h-[90vh] w-full max-w-5xl rounded-lg bg-white shadow-xl">
                ...
                <div className="rounded-lg border border-green-200 bg-green-50 p-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mt-1 text-xs text-green-600">This image will be used as the starting frame for video generation.</p>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="flex items-center justify-end gap-3 border-t border-gray-200 bg-gray-50 px-6 py-4">
            ...
            {!generatedVideoUrl && (
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-purple-600 px-6 py-2 text-sm font-medium text-white transition-colors hover:bg-purple-700 disabled:cursor-not-allowed disabled:bg-gray-300"
              >
                {isGenerating
                  ? (
                      <>
        ...
        {/* Right Panel - Preview */}
        <div className="flex w-[500px] flex-col items-center justify-center border-l border-gray-200 bg-black p-0">
          {generatedVideoUrl
            ? (
            ...
            : (
                <div className="p-6 text-center">
                  ...
                  <h3 className="mb-2 text-sm font-semibold text-white">Video Preview</h3>
